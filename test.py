...
class TestTiny(unittest.TestCase):
    ...
    def test_02(self):
        self.assertTrue(set([2876, 1532]) == lab.actors_with_bacon_number(self.data, 1))
        
    def test_03(self):
        self.assertTrue(set([4724]) == lab.actors_with_bacon_number(self.data, 0))
    
    def test_04(self):
        self.assertTrue(set([1640]) == lab.actors_with_bacon_number(self.data, 2))
